            ...
            <div class="feature-grid">
                ...
                <div class="feature-card">
                    <div class="column">
                        ...
                        <div class="space-y-2">
                            <h3> React 18 </h3>
                            <p> Server and Client Components. Use hook. </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="feature-card">
                    <div class="column">
                        ...
                        <div class="space-y-2">
                            <h3> Database </h3>
                            <p> ORM using Prisma and deployed on PlanetScale. </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="feature-card">
                    <div class="column">
                        ...
                        <div class="space-y-2">
                            ...
                            <p> Authentication using NextAuth.js and middlewares. </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="feature-card">
                    <div class="column">
                        ...
                        <div class="space-y-2">
                            <h3> Subscriptions </h3>
                            <p> Free and paid subscriptions using Stripe. </p>
                        </div>
                    </div>
                </div>
            </div>
